...
The dashboard loads the CSV files from `profiling/raw/` and shows comparison tables, key metrics, and interactive Plotly charts. Dependencies include **Streamlit**, **pandas**, and **Plotly** (see `app/requirements.txt`).
